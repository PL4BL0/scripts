...
directorios_local=("/batch/home/bctrl-m" "/batch/usr/cobol/salto/resumenes" "/batch/historicos")
...
sincronizar_directorio() {
    local directorio="$1"
    aws s3 sync "$directorio" "$ruta_s3""$directorio"  --exclude "/batch/historicos/inv*"  --only-show-errors 2>> /home/srvbackup/errores/batch/"$nombre_archivo"
}
